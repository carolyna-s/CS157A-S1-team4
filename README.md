...
4. org.json jar also needs to be in tomcat lib folder (its used for parsing the flight API response) download from https://repo1.maven.org/maven2/org/json/json/20240303/json-20240303.jar and put it in tomcat/lib
